...
export default function NavBar() {
  return (
    ...
    flex items-center justify-between text-xl max-md:text-lg max-sm:text-base px-20 max-sm:px-5 font-medium max-sm:gap-10">
      <a href="/" k className="flex items-center justify-center gap-4 h-4/5 ">
        {/* <FaYoutube size={20} color="#FF0000" /> */}
        <img src={websiteLogo} className="h-[95%] rounded-full hover:scale-105 hover:transition-all duration-150" alt="" />
